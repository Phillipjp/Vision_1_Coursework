...
data_path = '\\ueahome4\stusci3\xju14zpu\data\Documents\MATLAB\data';
...
switch lower(FEATURE)    
    case 'tiny image'
       ...
       train_image_feats = get_tiny_images2(train_image_paths, 8);
       test_image_feats  = get_tiny_images2(test_image_paths, 8);
    case 'colour histogram'
        %You should allow get_colour_histograms to take parameters e.g.
        %quantisation, colour space etc.
        train_image_feats = get_colour_histograms(train_image_paths, 8, 1);
        test_image_feats  = get_colour_histograms(test_image_paths, 8, 1);
end
...
for k = 1 : 2 : 32
    ...
    switch lower(CLASSIFIER)    
        ...
        predicted_categories = knn(train_image_feats, train_labels, test_image_feats, k, DISTANCE);
    end
    ...
    output(index) = create_results_webpage( train_image_paths, ...
                            test_image_paths, ...
                            train_labels, ...
                            test_labels, ...
                            categories, ...
